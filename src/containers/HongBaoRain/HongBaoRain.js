...
class HongBaoRain extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
    ...
    return (
      ...
      > 
        ...
        <View style={{ alignItems: "center" }}>
            ...
            >
              ...
              <View style={styles.stepBox}>
                ...
                <View style={styles.stepDetails}>
                  <Text style={styles.stepDetailText}>注册或登入您的账户</Text>
          ...
          {/* 活动详情 */}
          {/* <ImageBackground
            source={require("../../images/hongbao/box-2.png")}
            style={styles.box2}
          >
            <View style={styles.labelBox}>
              <Text style={styles.labelText}>活动详情</Text>
            </View>
            <View style={styles.detailBox}>
              <View style={styles.detailItem}>
                <ImageBackground
                  source={require("../../images/hongbao/titleBg.png")}
                ...
                <View>
                  <Text style={styles.detailTitle}>
                    存款满<Text style={styles.titleGold}>300</Text>
                    元获取一次抽奖机会
                  </Text>
