...
export default class VideoPlayScreen extends Component {
  ...
  render() {
   const{videoWidth , videoHeight,isFullScreen} = this.state;
    return (
      <View style={styles.container} >
        <View style={{ width: videoWidth, height: videoHeight, backgroundColor:'#000000',position:isFullScreen == true ? 'absolute' :'relative' }}>
          <Video
                ...
                this.state.isPlaying ? null :
                  <TouchableWithoutFeedback onPress={() => { this.onPressPlayButton() }}>
                    <Image
                      ...
                      source={require('../../images/video/icon_video_play.png')}
                    />
              ...
              <View style={[styles.control, {width: videoWidth}]}>
                <TouchableOpacity activeOpacity={0.3} onPress={() => { this.onControlPlayPress() }}>
                  <Image
                    ...
                    source={this.state.isPlaying ? require('../../images/video/icon_control_pause.png') : require('../../images/video/icon_control_play.png')}
                  />
                </TouchableOpacity>
                ...
                <Slider
                  ...
                  thumbImage={require('../../images/video/icon_control_slider.png')}
                ...
                {/* <TouchableOpacity activeOpacity={0.3} onPress={() => { this.onControlShrinkPress(this.state.isFullScreen == false ? true : false) }}>
                  <Image
                    style={styles.shrinkControl}
                    source={this.state.isFullScreen ? require('../../images/video/icon_control_shrink_screen.png') : require('../../images/video/icon_control_full_screen.png')}
                  />
                </TouchableOpacity> */}
              </View> : null
          }
