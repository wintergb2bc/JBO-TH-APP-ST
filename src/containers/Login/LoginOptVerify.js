...
class LoginOptVerify extends React.Component {
  constructor(props) {
    ...
    console.log('password',this.props.password,'username',this.props.username)
  }
  ...
  getRemainingAttempts = () => {
    return fetchRequest(
      ApiPort.VerifyOtpRemainingAttempts + "verificationType=LoginAuthorize&",
      "GET"
    )
      .then((res) => {
  ...
  clickVerifyType = (type) => {
    ...
    console.log(type);
    if (type == "phone") {
      UMonEvent("Navigation", "Click", "Phone_loginOTP");
    } else {
      UMonEvent("Navigation", "Click", "Email_loginOTP");
    }
    this.setState({ verificationType: type }, () => {
      Actions.OtpVerification({
        ...
        // verifyTimes: this.state.verifyTimes,
        ...
        // getRemainingAttempts:this.getRemainingAttempts
      });
    });
  };
          ...
          <View>
            ...
            <View style={{ paddingVertical: 20, paddingHorizontal: 15 }}>
              ...
              <View style={{ paddingVertical: 20, paddingHorizontal: 15 }}>
                ...
                >
                  {console.log(1212, Email, emailVerifyTimes, smsVerifyTimes,isEmailWithinTD)}
                  {loadingFinished &&
                 Email && 
                  ...
                  >
                    {/* <View style={[styles.otpImgWrap,{marginLeft:!Email ? 0 : 15}]}> */}
                    <View style={styles.otpImgWrap}>
                      <Image
                        resizeMode="stretch"
            ...
            {/*    initialVal={Phone || ""}*/}
            {/*    // openCustomerService={()=>this.navigateToScene("cs")}*/}
            {/*    setverificationType= {(v)=>{this.setState({verificationType:v})}}*/}
            {/*    // routerPush={()=>this.navigateToScene("login")}*/}
            {/*/>*/}
            {/*}*/}
